...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::group(['prefix' => 'alumni'], function () {
        Route::get('/', [AlumniController::class, 'index'])->name('index_alumni');
        Route::get('aktif', [AlumniController::class, 'alumni_aktif'])->name('alumni_aktif');
        Route::get('non-aktif', [AlumniController::class, 'alumni_non_aktif'])->name('alumni_non_aktif');
    });
    Route::group(['prefix' => 'donasi'], function () {
        Route::get('/', [DonasiController::class, 'index'])->name('index_donasi');
        Route::get('list', [DonasiController::class, 'list_donasi'])->name('list_donasi');
        Route::get('riwayat', [DonasiController::class, 'riwayat_donasi'])->name('riwayat_donasi');
        Route::get('edit/{id}', [DonasiController::class, 'edit_donasi'])->name('edit_donasi');
    });
    Route::get('events', [EventController::class, 'index'])->name('events');
    Route::group(['prefix' => 'referensi'], function () {
        Route::get('/dpw', [ReferensiController::class, 'index'])->name('ref.dpw');
        Route::get('/admin', [ReferensiController::class, 'admin'])->name('ref.admin');
    });
    //Route::view('events','livewire.home');
});
Route::get('kirim-email', [DashboardController::class, 'kirim_email'])->name('kirim-email');
/* Route Dashboards */
Route::group(['prefix' => 'dashboard'], function () {
    Route::get('analytics', [DashboardController::class, 'dashboardAnalytics'])->name('dashboard-analytics');
    Route::get('ecommerce', [DashboardController::class, 'dashboardEcommerce'])->name('dashboard');
});
/* Route Dashboards */
