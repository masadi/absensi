...
class PageController extends Controller
{
    ...
    public function get_pengumuman(Request $request){
        $data_sekolah = Sekolah::where('bentuk_pendidikan_id', $request->bentuk_pendidikan_id)->orderBy('npsn')->get();
        $all_jalur = Jalur::where('bentuk_pendidikan_id', $request->bentuk_pendidikan_id)->get();
        return view('page.pengumuman', compact(['data_sekolah', 'all_jalur']))->render();
    }
    /*
