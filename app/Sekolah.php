...
class Sekolah extends Model
{
    ...
    public function sekolah_pilihan(){
        return $this->hasMany('App\Sekolah_pilihan', 'sekolah_id', 'sekolah_id');
    }
    public function pagu(){
        return $this->hasMany('App\Pagu', 'sekolah_id', 'sekolah_id');
    }
    public function pagu_single(){
        return $this->hasOne('App\Pagu', 'sekolah_id', 'sekolah_id');
    }
