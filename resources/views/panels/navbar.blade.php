...
<div class="navbar-container d-flex content">
  <div class="bookmark-wrapper d-flex align-items-center">
    ...
    <ul class="nav navbar-nav bookmark-icons">
      <li class="nav-item d-none d-lg-block"><a href="{{ url('/') }}"
          data-bs-toggle="tooltip" data-bs-placement="bottom" title="Sistem Pendataan Alumni Darul Ulum Banyuanyar"><h2 class="brand-text">Sistem Pendataan Alumni Darul Ulum Banyuanyar</h2></a></li>
    </ul>
  </div>
