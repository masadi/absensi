                ...
                <div class="modal-body">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group">
                                    <input type="text" class="form-control"
                                        wire:change="getStart($event.target.value)" placeholder="Tanggal Mulai"
                                        aria-label="tanggal_mulai" id="tanggal_mulai" wire:model="tanggal_mulai">
                                    <span class="input-group-text">s/d</span>
                                    <input type="text" class="form-control" wire:change="getEnd($event.target.value)"
                                        placeholder="Tanggal Berakhir" aria-label="tanggal_akhir" id="tanggal_akhir"
                            ...
                            <div class="col-sm-9">
                                @foreach ($data_ptk as $urut => $ptk)
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" wire:model="ptk_selected"
                                            value="{{ $ptk->ptk_id }}" id="{{ $ptk->ptk_id }}">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-9">
                            @foreach ($nama_hari as $key => $hari)
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" wire:model="hari_selected"
                                        value="{{ $hari->nama }}" id="{{ $hari->nama }}">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                ...
                                <select class="form-select" id="scan_masuk_start_jam" aria-label="Pilih Jam"
                                    wire:model="scan_masuk_start_jam"
                                    aria-describedby="scan_masuk_start_jamHelpInline">
                                ...
                                <select class="form-select" id="scan_masuk_start_menit" aria-label="Pilih Jam"
                                    wire:model="scan_masuk_start_menit"
                                    aria-describedby="scan_masuk_start_menitHelpInline">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                <span class="input-group-text" wire:ignore><i data-feather="clock"></i></span>
                                <select class="form-select" id="scan_masuk_end_jam" aria-label="Pilih Jam"
                                    wire:model="scan_masuk_end_jam" aria-describedby="scan_masuk_end_jamHelpInline">
                                    <option selected>Pilih Jam</option>
                                    @for ($i = 0; $i < 24; $i++)
                                        <option value="{{ str_pad($i, 2, '0', STR_PAD_LEFT) }}">
                                            {{ str_pad($i, 2, '0', STR_PAD_LEFT) }}</option>
                                ...
                                <span class="input-group-text" wire:ignore>:</span>
                                <select class="form-select" id="scan_masuk_end_menit" aria-label="Pilih Jam"
                                    wire:model="scan_masuk_end_menit"
                                    aria-describedby="scan_masuk_end_menitHelpInline">
                                    <option selected>Pilih Menit</option>
                                    @for ($i = 0; $i < 60; $i++)
                                        <option value="{{ str_pad($i, 2, '0', STR_PAD_LEFT) }}">
                                            {{ str_pad($i, 2, '0', STR_PAD_LEFT) }}</option>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                <span class="input-group-text" wire:ignore><i data-feather="clock"></i></span>
                                <select class="form-select" id="waktu_akhir_masuk_jam" aria-label="Pilih Jam"
                                    wire:model="waktu_akhir_masuk_jam"
                                    aria-describedby="waktu_akhir_masuk_jamHelpInline">
                                    <option selected>Pilih Jam</option>
                                    @for ($i = 0; $i < 24; $i++)
                                        <option value="{{ str_pad($i, 2, '0', STR_PAD_LEFT) }}">
                                            {{ str_pad($i, 2, '0', STR_PAD_LEFT) }}</option>
                                ...
                                <span class="input-group-text" wire:ignore>:</span>
                                <select class="form-select" id="waktu_akhir_masuk_menit" aria-label="Pilih Jam"
                                    wire:model="waktu_akhir_masuk_menit"
                                    aria-describedby="waktu_akhir_masuk_menitHelpInline">
                                    <option selected>Pilih Menit</option>
                                    @for ($i = 0; $i < 60; $i++)
                                        <option value="{{ str_pad($i, 2, '0', STR_PAD_LEFT) }}">
                                            {{ str_pad($i, 2, '0', STR_PAD_LEFT) }}</option>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                <span class="input-group-text" wire:ignore><i data-feather="clock"></i></span>
                                <select class="form-select" id="scan_pulang_start_jam" aria-label="Pilih Jam"
                                    wire:model="scan_pulang_start_jam"
                                    aria-describedby="scan_pulang_start_jamHelpInline">
                                    <option selected>Pilih Jam</option>
                                    @for ($i = 0; $i < 24; $i++)
                                        <option value="{{ str_pad($i, 2, '0', STR_PAD_LEFT) }}">
                                            {{ str_pad($i, 2, '0', STR_PAD_LEFT) }}</option>
                                ...
                                <span class="input-group-text" wire:ignore>:</span>
                                <select class="form-select" id="scan_pulang_start_menit" aria-label="Pilih Jam"
                                    wire:model="scan_pulang_start_menit"
                                    aria-describedby="scan_pulang_start_menitHelpInline">
                                    <option selected>Pilih Menit</option>
                                    @for ($i = 0; $i < 60; $i++)
                                        <option value="{{ str_pad($i, 2, '0', STR_PAD_LEFT) }}">
                                            {{ str_pad($i, 2, '0', STR_PAD_LEFT) }}</option>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                <span class="input-group-text" wire:ignore><i data-feather="clock"></i></span>
                                <select class="form-select" id="scan_pulang_end_jam" aria-label="Pilih Jam"
                                    wire:model="scan_pulang_end_jam" aria-describedby="scan_pulang_end_jamHelpInline">
                                    <option selected>Pilih Jam</option>
                                    @for ($i = 0; $i < 24; $i++)
                                        <option value="{{ str_pad($i, 2, '0', STR_PAD_LEFT) }}">
                                            {{ str_pad($i, 2, '0', STR_PAD_LEFT) }}</option>
                                ...
                                <span class="input-group-text" wire:ignore>:</span>
                                <select class="form-select" id="scan_pulang_end_menit" aria-label="Pilih Jam"
                                    wire:model="scan_pulang_end_menit"
                                    aria-describedby="scan_pulang_end_menitHelpInline">
                                    <option selected>Pilih Menit</option>
                                    @for ($i = 0; $i < 60; $i++)
                                        <option value="{{ str_pad($i, 2, '0', STR_PAD_LEFT) }}">
                                            {{ str_pad($i, 2, '0', STR_PAD_LEFT) }}</option>
