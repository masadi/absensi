        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body pb-5 px-sm-4 mx-50">
                    <h1 class="address-title text-center mb-1" id="addNewAddressTitle">Edit Data Donasi</h1>
                    <form>
                        ...
                        <div class="col-12 text-center">
                            ...
                            <button type="button" wire:click.prevent="update()" class="btn btn-primary me-1 mt-2" data-dismiss="modal">Perbaharui</button>
